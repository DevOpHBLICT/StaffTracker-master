...
public partial class _Default : Page
{
    ...
    protected void grv_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        {
            e.Row.Cells[1].Text = "A In office / attending offsite meetings";

            e.Row.Cells[2].Text = "B Working from home";
            e.Row.Cells[3].Text = "Ci Self-isolating not with COVID symptoms personally - WORKING";
            e.Row.Cells[4].Text="Cii Self-Isolating not with COVID symptoms personally - NOT WORKING";
            e.Row.Cells[5].Text = "Di Has Covid symptoms - WORKING";
         e.Row.Cells[6].Text = "Dii Has Covid symptoms - NOT WORKING";
            e.Row.Cells[7].Text = "E Other sick";
            e.Row.Cells[8].Text = "F Annual leave / other absence including NWD";
            e.Row.Cells[9].Text = "G Redeployed outside CCG - OTHER NHS ORGANISATION";
            e.Row.Cells[10].Text = "H Redeployed outside CCG - OUTSIDE NHS";
